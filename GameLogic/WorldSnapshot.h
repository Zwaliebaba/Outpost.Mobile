...
struct ShipSnapshot
{
  ...
  // without that state evaporating at a shard boundary (ADR 0044). The server still uses handles
...
// handle and could not interpret one (ADR 0044).
struct MoveOrder
{
