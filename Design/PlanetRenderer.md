...
> **This design now describes one of the two kinds of body.** A *world* stopped being generated on
> 2026-08-30: it is a smooth sphere wearing an authored equirectangular map, and none of the height
> field, the colour ramp, the ocean or the outline below runs for it (`Design/Decisions/0026`). What
> this document still describes exactly, and is still reviewed against, is a **rock** — the six
> asteroids, which are generated by every rule here. The sea is gone entirely; where the text below
> describes an ocean world, read it as history.
