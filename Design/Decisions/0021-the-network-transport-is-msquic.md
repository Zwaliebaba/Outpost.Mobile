...
Status: accepted; one consequence superseded in part by [0027](0027-there-is-no-fallback-link.md)
Date: 2026-08-29
...
> Superseded in part by ADR 0027 (2026-08-30). The loopback is still not deleted and is still the
